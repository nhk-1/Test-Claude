  ...
  return (
    <div className="space-y-12 animate-fade-in">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-4">Suivez vos progrès</p>
      </div>

      {/* Tabs */}
      <div className="flex gap-4 p-2 bg-gray-100 dark:bg-gray-800 rounded-2xl overflow-x-auto scrollbar-hide">
        <button
          onClick={() => setActiveTab('weight')}
          className={`flex-1 min-w-[70px] py-4 px-4 rounded-lg font-medium transition-all btn-press whitespace-nowrap text-sm ${
            activeTab === 'weight'
      ...
      {activeTab === 'weight' && (
        <div className="space-y-12">
          {/* Add weight entry */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
            <h2 className="font-semibold text-gray-900 dark:text-white mb-8">Ajouter une pesée</h2>
            <div className="flex gap-3">
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full px-4 py-4 pr-12 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-base"
                />
              ...
              <button
                ...
                disabled={!newWeight}
                className="px-5 py-4 bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-medium rounded-xl transition-colors btn-press touch-target"
              >
                Ajouter
              </button>
            </div>
          ...
          {weightStats ? (
            <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">Actuel</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">
                    {weightStats.current.toFixed(1)} kg
                  </p>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">Variation totale</p>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">Min</p>
                  <p className="text-2xl font-bold text-emerald-500">{weightStats.min.toFixed(1)} kg</p>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">Max</p>
              ...
              {/* Chart */}
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                <h2 className="font-semibold text-gray-900 dark:text-white mb-8">Évolution du poids</h2>
                <LineChart
      ...
      {activeTab === 'performance' && (
        <div className="space-y-12">
          {/* Exercise selector */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
            <h2 className="font-semibold text-gray-900 dark:text-white mb-8">Sélectionnez un exercice</h2>
            {exercisesInSessions.length > 0 ? (
              <select
                value={selectedExercise}
                onChange={(e) => setSelectedExercise(e.target.value)}
                className="w-full px-4 py-4 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              >
          ...
          {selectedExercise && performanceData ? (
            <>
              ...
              <Link
                ...
                className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white rounded-xl p-5 shadow-sm flex items-center justify-between transition-all btn-press"
              >
                <div className="flex items-center gap-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">Charge actuelle</p>
                  <p className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">
                    {performanceData.latestWeight} kg
                  </p>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">Progression</p>
                  <p className={`text-2xl font-bold ${
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">Record (PR)</p>
                  <p className="text-2xl font-bold text-amber-500">{performanceData.maxWeight} kg</p>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">Séances</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                <h2 className="font-semibold text-gray-900 dark:text-white mb-8">Progression des charges (max par séance)</h2>
                <LineChart
              ...
              {/* Volume chart */}
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                <h2 className="font-semibold text-gray-900 dark:text-white mb-3">Volume d'entraînement</h2>
                <p className="text-sm text-gray-500 mb-8">Volume = Poids x Reps x Séries</p>
                <LineChart
                  data={performanceData.dataPoints}
                  getY={(d) => d.volume}
                  color="#8b5cf6"
          ...
          {muscleGroupStats.length > 0 ? (
            <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">Groupes travaillés</p>
                  <p className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">
                    {muscleGroupStats.length}
                  </p>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">Plus travaillé</p>
                  <p className="text-lg font-bold text-gray-900 dark:text-white">
                    {MUSCLE_CATEGORY_LABELS[muscleGroupStats[0]?.category] || '-'}
                  </p>
                </div>
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm col-span-2 md:col-span-1">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">Volume total</p>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                <h2 className="font-semibold text-gray-900 dark:text-white mb-8">Répartition du volume par groupe musculaire</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {muscleGroupStats.map((stat) => {
                  ...
                  return (
                    <div key={stat.category} className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
            ...
            <>
              ...
              {(() => {
                ...
                return (
                  <>
                    {/* Fatigue Card */}
                    <div className={`rounded-2xl p-7 shadow-sm border-2 ${
                    ...
                    {deloadCheck.shouldDeload && (
                      <div className="bg-amber-50 dark:bg-amber-900/20 border-2 border-amber-500 rounded-2xl p-7">
                        <div className="flex gap-4">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm">
                ...
                <div className="space-y-5">
                  {exercisesInSessions.slice(0, 5).map((ex) => {
                    ...
                    return (
                      <div key={ex.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        <div>
              ...
              {(() => {
                ...
                return (
                  <div className="bg-orange-50 dark:bg-orange-900/20 border-2 border-orange-500 rounded-2xl p-7">
                    <h3 className="text-lg font-semibold text-orange-900 dark:text-orange-200 mb-3">
                      Plateaux Détectés
                    </h3>
                    <p className="text-sm text-orange-800 dark:text-orange-300 mb-8">
                      Ces exercices n'ont pas progressé depuis 4+ semaines
                    </p>
                    <div className="space-y-4">
                      {exercisesWithPlateau.map((ex: any) => (
                        <div key={ex.id} className="flex items-center gap-3 text-sm text-orange-900 dark:text-orange-200">
                          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M5 12h14" />
                          </svg>
                          {ex.name}
