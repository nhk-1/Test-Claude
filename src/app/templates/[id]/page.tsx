...
import { TemplateExercise, MUSCLE_CATEGORY_LABELS, WorkoutTemplate } from '@/lib/types';
import { getExerciseById } from '@/lib/exercises';

export default function EditTemplatePage() {
  const { data, updateTemplate, addExerciseToTemplate, removeExerciseFromTemplate, reorderExercisesInTemplate } = useApp();
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          <p className="text-gray-500 dark:text-gray-400">Template non trouvé</p>
          <button
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      {/* Form */}
      <div className="bg-white dark:bg-gray-800 rounded-xl p-7 shadow-sm space-y-5">
        <div>
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="flex items-center gap-3 px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors"
          >
