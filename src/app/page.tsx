  ...
  return (
    <div className="animate-fade-in">
      ...
      {activeSession && (
        <Link
          href="/session"
          className="block gradient-bg rounded-2xl p-6 md:p-8 text-white shadow-xl shadow-indigo-500/20 hover:shadow-indigo-500/30 transition-all duration-300 hover:-translate-y-0.5 mb-10"
        >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 md:gap-7">
          ...
          {streak > 0 && (
            <div className="gradient-bg-warm rounded-2xl p-6 md:p-8 text-white shadow-lg shadow-orange-500/20">
              ...
              <p className="text-sm text-white/80 mt-3 font-medium">{streak === 1 ? 'jour' : 'jours'} consécutifs</p>
            </div>
          )}

          {/* This Week */}
          <div className="stat-card">
            <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-4">Cette semaine</p>
          ...
          {/* Total Sessions */}
          <div className="stat-card">
            <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-4">Total</p>
          ...
          {/* Templates */}
          <div className="stat-card">
            <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-4">Templates</p>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1.5">séries</p>
                  </div>
                </div>
              );
            })}
