  ...
  return (
    <div className="space-y-12 animate-fade-in">
      ...
      {activeSession && (
        <Link
          href="/session"
          className="block bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-shadow"
        >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        {streak > 0 && (
          <div className="bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl p-6 shadow-sm text-white">
            ...
            <p className="text-sm opacity-90 mt-2">{streak === 1 ? 'jour' : 'jours'}</p>
          </div>
        )}

        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">Cette semaine</p>
          <p className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">
            {thisWeekSessions.length}
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">séances</p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">Templates</p>
          <p className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">
            {data.templates.length}
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">créés</p>
        </div>
      </div>
              ...
              return (
                <div key={session.id} className="p-6 flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">séries</p>
                  </div>
                </div>
              );
            })}
