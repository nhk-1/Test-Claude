  ...
  return (
    <div className="animate-fade-in space-y-10">
      ...
      <section className="card p-7 md:p-9">
        <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-8 flex items-center gap-4">
        ...
        {user ? (
          <div className="space-y-7">
            <div className="flex items-center gap-5 p-5 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
            ...
            <button
              ...
              className="btn btn-secondary w-full py-5"
            >
              Se déconnecter
            </button>
          </div>
          ...
          <p className="text-slate-600 dark:text-slate-400 text-center py-5">
      ...
      <section className="card p-7 md:p-9">
        ...
        <div className="space-y-5">
          {/* Export */}
          <div className="flex items-center justify-between p-6 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
            <div>
      ...
      {/* Danger Zone */}
      <section className="card p-7 md:p-9 border-2 border-red-200 dark:border-red-500/30">
        <h2 className="text-lg font-bold text-red-600 dark:text-red-400 mb-8 flex items-center gap-4">
        ...
        <div className="flex items-center justify-between p-6 bg-red-50 dark:bg-red-500/10 rounded-xl">
          <div>
