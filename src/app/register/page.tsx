    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-5 safe-area-top safe-area-bottom">
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-10 shadow-lg max-w-md w-full text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Compte créé !</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Vérifiez votre email pour confirmer votre compte, puis connectez-vous.
          </p>
          <Link
            href="/login"
            className="inline-block py-4 px-6 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-xl transition-colors"
          >
            Se connecter
          </Link>
        </div>
    ...
    <div className="min-h-screen flex items-center justify-center p-5 safe-area-top safe-area-bottom">
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-10 shadow-lg max-w-md w-full">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Commencez à suivre vos entraînements</p>
        </div>
